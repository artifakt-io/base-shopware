...
su -s /bin/sh -c 'php /var/www/html/bin/console sales-channel:create:storefront --name=Storefront --url="$APP_URL"' www-data
su -s /bin/sh -c 'php /var/www/html/bin/console theme:change --all Storefront' www-data
