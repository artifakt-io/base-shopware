...
<h1>Artifakt Sample Shopware App</h1>
...
For complete documentation about the Shopware project, please refer to the official [README](./README-original.md) file
...
You can use this stack to run a complete Shopware stack with MySQL in a few docker-compose lines.
